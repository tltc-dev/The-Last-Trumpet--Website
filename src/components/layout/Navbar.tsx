...
const Navbar = (props: Props) => {
  ...
  return (
    <motion.div
      ...
      className="w-full fixed  top-0 h-14 z-30 backdrop-blur-lg text-white mix-blend-difference border-b border-gray-100/10 "
    >
      <div className="padding h-14 flex flex-row items-center justify-between">
        <a href="/" className="">
          Logo
        </a>
        <div className="flex items-center gap-10 font-poppins text-sm font-light text-white opacity-80">
